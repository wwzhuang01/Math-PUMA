...
MODEL_PATH = Path(os.environ.get("ORIGIN_MODEL_PATH", "/mnt/bn/gmma/zxt/saves/R_Qwen2VLM-7B-aligned_D_0809_13"))
...
DATA_PATH = os.environ.get("DATA_PATH",
    "/mnt/bn/gmma/datasets/MathV-360K-2/free_form-with_proc.jsonl"
)
...
TRAINABLE_PARTS = str(os.environ.get(   # "aligner, language_model, vision_tower_low, vision_tower_high" or "all"
    "TRAINABLE_PARTS", "aligner"
))

# KL
USE_KL = str(os.environ.get("USE_KL", "false")) 
...
train_args = (
    ...
    f" --fsdp_transformer_layer_cls_to_wrap 'Qwen2DecoderLayer'"
    f" --seed {SEED}"
)
